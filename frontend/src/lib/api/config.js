...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    RESTAURANT_SEND_CREDENTIALS: '/admin/restaurants/:id/send-credentials',
    ...
    ORDER_ACCEPT_RESTAURANT: '/admin/orders/:orderId/accept-restaurant',
